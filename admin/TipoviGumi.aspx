<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TipoviGumi.aspx.cs" Inherits="TreningVozac" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Типови гуми</title>
    <style type="text/css">
        .auto-style1 {
            width: 100%;
        }
...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing"  Width="237px" OnRowUpdating="GridView1_RowUpdating" CssClass="tabela">
            <Columns>
