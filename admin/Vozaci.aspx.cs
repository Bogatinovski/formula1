...
public partial class Vozaci : System.Web.UI.Page
{
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        try
        {
            ...
            tb = GridView1.Rows[e.RowIndex].Cells[15].Controls[0] as TextBox;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            command.CommandText = "INSERT INTO vozac (id, ime, nacionalnost, tituli, vkupna_jacina, koncentracija, talent, agresivnost, " +
                "iskustvo, tehnika, izdrzlivost, motivacija, harizma, godini, plata, tezina, NAGRADAPRIPOTPISUVANJE) VALUES (:id, :ime, :nacionalnost, " +
