<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Standings.aspx.cs" Inherits="Standings" %>
            ...
            <form id="form1" runat="server">
                <div>
                    ...
                    <asp:GridView ID="gvVkupno" runat="server" CssClass="tabela" AutoGenerateColumns="false">
                         <Columns>
                             <asp:TemplateField HeaderText="Позиција">
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("pozicija").ToString()  %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Поени">
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("poeni").ToString()  %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
